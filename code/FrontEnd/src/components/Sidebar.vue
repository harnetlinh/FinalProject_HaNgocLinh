            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    ...
                    <b-collapse id="collapse-1">
                        <ul id="collapse-1">
                            <li><router-link to='/dashboard/text-to-speech'>Home page</router-link></li>
                            <li><router-link to='/dashboard/feedback'>Feedback</router-link></li>
                            <li><router-link to='/dashboard/howtouse'>How to use</router-link></li>
                            <li><router-link to='/dashboard/about'>About Us</router-link></li>
                        </ul>
                    </b-collapse>
                </li>
                <!-- <li>
